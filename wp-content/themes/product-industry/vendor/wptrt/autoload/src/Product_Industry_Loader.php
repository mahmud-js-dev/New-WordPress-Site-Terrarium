...
class Product_Industry_Loader {
	 ...
	 * @return void
	 */
	public function product_industry_add( $prefix, $paths ) {
	 ...
	 * @return void
	 */
	public function product_industry_remove( $prefix, $path = '' ) {
	 ...
	 * @return bool
	 */
	public function product_industry_has( $prefix, $path = '' ) {
		if ( $path ) {
	 ...
	 * @return void
	 */
	public function product_industry_register() {

		if ( $this->loaders ) {

			spl_autoload_register( function( $class ) {

				$this->product_industry_load( $class );
			}, true, true );
		}
	}
	/**
	 ...
	 * @return void
	 */
	protected function product_industry_load( $class ) {
